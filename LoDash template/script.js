...
console.log(result);
// шаблон просто заменил <%-title%> на значение свойства menuData.title .
// После чего в результат попал сначала текст <ul>, потом выполнился код forEach,
// который последовательно сгенерировал элементы списка,
// и затем список был закрыт </ul>.
